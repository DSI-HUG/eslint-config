...
> NOTE:<br /> If you need to update the commit message of an earlier commit, you can use `git rebase` in interactive mode. See the [git docs](https://git-scm.com/docs/git-rebase#_interactive_mode) for more details.
...
[coc]: https://github.com/dsi-hug/eslint-config/blob/main/CODE_OF_CONDUCT.md
